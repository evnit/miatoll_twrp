...
KERNEL_PATH := prebuilt
BOARD_PREBUILT_DTBIMAGE_DIR := $(DEVICE_PATH)/$(KERNEL_PATH)/dtbs
TARGET_PREBUILT_KERNEL := $(DEVICE_PATH)/$(KERNEL_PATH)/kernel
BOARD_PREBUILT_DTBOIMAGE := $(DEVICE_PATH)/$(KERNEL_PATH)/dtbo
